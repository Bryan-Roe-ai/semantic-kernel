...
def main():
    ...
    print("4. 📞 Add contact information where marked '[Contact information to be added]'")
    ...
    print("sed -i 's|<repository-url>|https://github.com/yourusername/semantic-kernel|g' NOTICE")
    print("")
    print("# Update email in package.json files:")
    print("find . -name 'package.json' -exec sed -i 's|bryan.roe@example.com|your.email@domain.com|g' {} \\;")
    print("")
