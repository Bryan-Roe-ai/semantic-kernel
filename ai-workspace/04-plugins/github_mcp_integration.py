#!/usr/bin/env python3
"""
AI Workspace GitHub MCP Integration

This module provides GitHub integration using MCP (Model Context Protocol)
for the AI workspace, enabling repository analysis, issue management, and
automated workflows.
"""
