    ...
    def _deserialize_store_model_to_data_model(
        ...
        try:
            if hasattr(self.data_model_type, "deserialize"):
                if isinstance(record, Sequence):
<<<<<<< HEAD:python/semantic_kernel/data/vector_store_record_collection.py
                    return [
...
>>>>>>> 5ae74d7dd619c0f30c1db7a041ecac0f679f9377:python/semantic_kernel/data/vector_storage/vector_store_record_collection.py
        return None
