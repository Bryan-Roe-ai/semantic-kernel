...
/// <summary>
/// This example demonstrates the similarity between using <see cref="AzureAIAgent"/> and other agent types.
/// Improved summary: Shows how to use a YAML template to create an Azure AI agent, set arguments, and interact with it in a conversation thread.
/// </summary>
