#!/usr/bin/env python3
"""
Endless Improvement Loop module
...
class EndlessImprovementLoop:
    ...
    def _initialize_agents(self):
        ...
        try:
            from comprehensive_agents import SwarmIntelligenceAgent
            self.agents.append(SwarmIntelligenceAgent("swarm_intelligence", self.workspace_root))
        except ImportError:
            logger.info("Swarm intelligence agent not available")
