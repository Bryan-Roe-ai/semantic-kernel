#!/usr/bin/env python3
"""DEPRECATION SHIM: unified_launcher.py moved to scripts/unified_launcher.py"""
import importlib
print("[DEPRECATED] unified_launcher.py moved to scripts/unified_launcher.py")
impl = importlib.import_module('scripts.unified_launcher')
