#!/usr/bin/env python3
"""DEPRECATION SHIM: master_launcher.py moved to scripts/master_launcher.py"""
import importlib
print("[DEPRECATED] master_launcher.py moved to scripts/master_launcher.py")
impl = importlib.import_module('scripts.master_launcher')
